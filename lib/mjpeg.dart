...
class MjpegPreprocessorWithFrameGrabber extends MjpegPreprocessor {
  MjpegPreprocessorWithFrameGrabber();
  List<int> _frame = List.empty(growable: true);
  ...
  ImageProvider get image {
    return MemoryImage(Uint8List.fromList(_frame));
  }

  Uint8List get u8list {
